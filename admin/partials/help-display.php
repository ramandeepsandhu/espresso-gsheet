    ...
    <div id="service_account_help">
        ...
        <div id='step_6'>
            ...
            <p>
                ...
                <!-- Loading Ends -->
                <br>
                <b>1.</b> Click the <code><b> ENABLE</b></code> button. and enable Google Sheets API.
                <br><br>
                <!-- Loading Starts -->
        ...
        <div id='step_8'>
            ...
            <p>
                ...
                <br><br>
                <b>5.</b> Click the <code><b> CREATE</b></code> button.
                <br><br>
                <!-- Loading Starts -->
                <img  style="display: block; margin: 0 auto;"  width="80%" height="80%" src="<?php echo plugins_url( '../css/screenshot-15.png', __FILE__  ); ?>" alt="loading...">
                <!-- Loading Ends -->
                <br>
                <b>1.</b> Change the Role to <code><b> Editor</b></code>
                <br>
                <b>2.</b> Click to the <code><b> CONTINUE</b></code>
                <br><br>
                <!-- Loading Starts -->
                <img  style="display: block; margin: 0 auto;"  width="80%" height="80%" src="<?php echo plugins_url( '../css/screenshot-16.png', __FILE__  ); ?>" alt="loading...">
                <!-- Loading Ends -->

                <br>
                <b>1.</b> Click <code><b> DONE</b></code>
                <br><br>

                <!-- Loading Starts -->
                <img  style="display: block; margin: 0 auto;"  width="80%" height="80%" src="<?php echo plugins_url( '../css/screenshot-17.png', __FILE__  ); ?>" alt="loading...">
                <!-- Loading Ends -->

                <br>
                <b>1.</b> Click to the <code><b> ADD KEY</b></code> Dropdown.
                <br>
                <b>2.</b> Select <code><b> Create new key</b></code> Dropdown.
                <br>
                <b>3.</b> Click on <code><b> SAVE</b></code>
                <br><br>

                <!-- Loading Starts -->
                <img  style="display: block; margin: 0 auto;"  width="80%" height="80%" src="<?php echo plugins_url( '../css/screenshot-18.png', __FILE__  ); ?>" alt="loading...">
                <!-- Loading Ends -->

                <br>
                <b>1.</b> Select <code><b> JSON</b></code> on popups.
                <br>
                <b>2.</b> Click on <code><b> CREATE</b></code>  after that a JSON file will download on your PC. Open that file & copy tha content carefully  <code><b> as is</b></code>
                <br><br>
